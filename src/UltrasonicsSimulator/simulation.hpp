...
public:
    ...
    void optimise_Gorkov_laplacian(const std::vector<std::array<double, 3> >&, const double, const double, const double, const bool, const bool, const bool, const double, const double, const std::string);
