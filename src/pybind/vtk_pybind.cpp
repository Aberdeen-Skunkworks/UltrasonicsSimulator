...

{
    ...
    m.def("dump", py::overload_cast<const Simulation&, const std::string>(&vtu::dump));
    m.def("dump", py::overload_cast<const std::vector<Transducer>&, const std::string>(&vtu::dump));
